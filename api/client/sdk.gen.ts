 ...
 */
export const deleteAuthorById = <ThrowOnError extends boolean = false>(
  options: Options<DeleteAuthorByIdData, ThrowOnError>,
) => {
 ...
 */
export const getAuthorById = <ThrowOnError extends boolean = false>(
  options: Options<GetAuthorByIdData, ThrowOnError>,
) => {
 ...
 */
export const updateAuthorById = <ThrowOnError extends boolean = false>(
  options: Options<UpdateAuthorByIdData, ThrowOnError>,
) => {
 ...
 */
export const deleteAuthorImageById = <ThrowOnError extends boolean = false>(
  options: Options<DeleteAuthorImageByIdData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    unknown,
    DeleteAuthorImageByIdError,
 ...
 */
export const getAuthorImageById = <ThrowOnError extends boolean = false>(
  options: Options<GetAuthorImageByIdData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetAuthorImageByIdResponse,
    GetAuthorImageByIdError,
 ...
 */
export const updateAuthorImageById = <ThrowOnError extends boolean = false>(
  options: Options<UpdateAuthorImageByIdData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).patch<
    UpdateAuthorImageByIdResponse,
    UpdateAuthorImageByIdError,
 ...
 */
export const addAuthorImageById = <ThrowOnError extends boolean = false>(
  options: Options<AddAuthorImageByIdData, ThrowOnError>,
) => {
 ...
 */
export const matchAuthorById = <ThrowOnError extends boolean = false>(
  options: Options<MatchAuthorByIdData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    MatchAuthorByIdResponse,
    MatchAuthorByIdError,
 ...
 */
export const getEmailSettings = <ThrowOnError extends boolean = false>(
 ...
 */
export const updateEmailSettings = <ThrowOnError extends boolean = false>(
 ...
 */
export const updateEReaderDevices = <ThrowOnError extends boolean = false>(
  options: Options<UpdateEReaderDevicesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    UpdateEReaderDevicesResponse,
    unknown,
 ...
 */
export const sendEBookToDevice = <ThrowOnError extends boolean = false>(
  options: Options<SendEBookToDeviceData, ThrowOnError>,
) => {
 ...
 */
export const deleteLibraryById = <ThrowOnError extends boolean = false>(
  options: Options<DeleteLibraryByIdData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    DeleteLibraryByIdResponse,
    DeleteLibraryByIdError,
 ...
 * Get a single library by ID on server.
 */
export const getLibraryById = <ThrowOnError extends boolean = false>(
  options: Options<GetLibraryByIdData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetLibraryByIdResponse,
    GetLibraryByIdError,
 ...
 * Update a single library by ID on server.
 */
export const updateLibraryById = <ThrowOnError extends boolean = false>(
  options: Options<UpdateLibraryByIdData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).patch<
    UpdateLibraryByIdResponse,
    UpdateLibraryByIdError,
 ...
 */
export const getLibraryAuthors = <ThrowOnError extends boolean = false>(
  options: Options<GetLibraryAuthorsData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetLibraryAuthorsResponse,
    GetLibraryAuthorsError,
 ...
 */
export const getLibraryItems = <ThrowOnError extends boolean = false>(
  options: Options<GetLibraryItemsData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetLibraryItemsResponse,
    GetLibraryItemsError,
 ...
 */
export const deleteLibraryIssues = <ThrowOnError extends boolean = false>(
  options: Options<DeleteLibraryIssuesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    DeleteLibraryIssuesResponse,
    DeleteLibraryIssuesError,
 ...
 */
export const getLibrarySeries = <ThrowOnError extends boolean = false>(
  options: Options<GetLibrarySeriesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetLibrarySeriesResponse,
    GetLibrarySeriesError,
 ...
 */
export const getLibrarySeriesById = <ThrowOnError extends boolean = false>(
  options: Options<GetLibrarySeriesByIdData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetLibrarySeriesByIdResponse,
    GetLibrarySeriesByIdError,
...
>(
  options?: Options<ConfigureNotificationSettingsData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).patch<
    ConfigureNotificationSettingsResponse,
    ConfigureNotificationSettingsError,
 ...
 */
export const getNotificationEventData = <ThrowOnError extends boolean = false>(
  options?: Options<GetNotificationEventDataData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).get<
    GetNotificationEventDataResponse,
    GetNotificationEventDataError,
...
export const sendDefaultTestNotification = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<SendDefaultTestNotificationData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).get<
    SendDefaultTestNotificationResponse,
    SendDefaultTestNotificationError,
 ...
 */
export const createPodcast = <ThrowOnError extends boolean = false>(
 ...
 * Get podcast feed
 */
export const getPodcastFeed = <ThrowOnError extends boolean = false>(
  options: Options<GetPodcastFeedData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    GetPodcastFeedResponse,
    unknown,
 ...
 */
export const getFeedsFromOpmlText = <ThrowOnError extends boolean = false>(
  options?: Options<GetFeedsFromOpmlTextData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).post<
    GetFeedsFromOpmlTextResponse,
    unknown,
...
export const bulkCreatePodcastsFromOpmlFeedUrls = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<BulkCreatePodcastsFromOpmlFeedUrlsData, ThrowOnError>,
) => {
  return (options?.client ?? _heyApiClient).post<
    unknown,
    unknown,
 ...
 */
export const checkNewEpisodes = <ThrowOnError extends boolean = false>(
  options: Options<CheckNewEpisodesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    CheckNewEpisodesResponse,
    unknown,
 ...
 */
export const clearEpisodeDownloadQueue = <ThrowOnError extends boolean = false>(
  options: Options<ClearEpisodeDownloadQueueData, ThrowOnError>,
) => {
 ...
 */
export const getEpisodeDownloads = <ThrowOnError extends boolean = false>(
  options: Options<GetEpisodeDownloadsData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetEpisodeDownloadsResponse,
    unknown,
 ...
 */
export const findEpisode = <ThrowOnError extends boolean = false>(
  options: Options<FindEpisodeData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    FindEpisodeResponse,
    unknown,
 ...
 */
export const downloadEpisodes = <ThrowOnError extends boolean = false>(
  options: Options<DownloadEpisodesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>(
    {
      security: [
 ...
 */
export const quickMatchEpisodes = <ThrowOnError extends boolean = false>(
  options: Options<QuickMatchEpisodesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    QuickMatchEpisodesResponse,
    unknown,
 ...
 */
export const removeEpisode = <ThrowOnError extends boolean = false>(
  options: Options<RemoveEpisodeData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).delete<
    RemoveEpisodeResponse,
    unknown,
 ...
 */
export const getEpisode = <ThrowOnError extends boolean = false>(
  options: Options<GetEpisodeData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).get<
    GetEpisodeResponse,
    unknown,
 ...
 */
export const updateEpisode = <ThrowOnError extends boolean = false>(
  options: Options<UpdateEpisodeData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).patch<
    UpdateEpisodeResponse,
    unknown,
 ...
 * Get a series by ID.
 */
export const getSeries = <ThrowOnError extends boolean = false>(
 ...
 */
export const updateSeries = <ThrowOnError extends boolean = false>(
  options: Options<UpdateSeriesData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).patch<
    UpdateSeriesResponse,
    UpdateSeriesError,
